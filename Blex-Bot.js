...
(function() {
    ...
    */
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get('https://dl.dropboxusercontent.com/s/zehygz9oqfrrcqf/langIndex.json', function(json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            commandLiteral: '!',
            blacklists: {
                NSFW: 'https://dl.dropboxusercontent.com/s/0m0rbyqit2ebbm5/NSFWlist.json',
        ...
        chatUtilities: {
            ...
            spam: [
                'hueh', 'hu3', 'arrombado', 'filho',  'brbr', 'da puta', 'heu', 'brbr', 'spoder', 'mafia', 'zuera', 'zueira',
